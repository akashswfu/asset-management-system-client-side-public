...
const Package = () => {
  ...
  return (
    <div>
      <h1 className="text-center uppercase text-4xl pt-20 text-green-500 text-transparent bg-gradient-to-r from-pink-600 to-yellow-600 hover:from-pink-700 hover:to-yellow-700 bg-clip-text">
        Chose Your Plan
      </h1>
      <div className="grid mt-16 grid-cols-1 md:grid-cols-3 gap-10">
        <div className="py-10 rounded-2xl bg-gradient-to-r text-center from-sky-400 to-sky-500 hidden md:flex flex-col justify-center items-center w-full h-full space-y-5 top-0">
