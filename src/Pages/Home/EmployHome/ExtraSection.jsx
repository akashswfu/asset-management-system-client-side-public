        ...
        <div className="w-full">
          ...
          <div className="pt-11 pb-8 border-b border-gray-100 max-xl:max-w-2xl max-xl:mx-auto">
            ...
            <p className="font-normal text-lg leading-8 text-gray-400 max-xl:text-justify">
              One of the standout features of Assets Management is its intuitive
              and user-friendly interface. Navigating through the system feels
          ...
          <div className="pt-8 max-xl:max-w-2xl max-xl:mx-auto">
            ...
            <p className="font-normal text-lg leading-8 text-gray-400 max-xl:text-justify">
              Your Assets Management doesn't disappoint when it comes to the
              variety and richness of its design components. From pre-built
              templates to customizable elements, the system caters to both
              beginners and seasoned designers. The extensive library ensures a
              diverse range of options to bring creative visions to life.
            </p>
          </div>
        </div>
      </div>
